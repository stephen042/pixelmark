...
<div class="container">
<h2>Available Land Collection </h2>
...
<div style="overflow-x:auto;">
  <table>
    ...
    <?php 
									$i = 1;
					$sql= "SELECT * FROM market WHERE status='approved' AND mstatus = 'ACTIVE' AND type = 'Land' ORDER BY id DESC ";
            ...
            ?>
                        ...
                        <tr>
                          ...
                          <td>
                             ...
                             <form method="POST" action="buy_land.php">
