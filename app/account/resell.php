...
if(isset($_POST['resell'])){
    $msgre = "";
    if (empty($_POST["nft"])) {
        $msgre = "NFT collection is required";
        echo "<script> alert('NFT collection is required');
      ...
      $sql1re = "SELECT * FROM market WHERE id = '$nft_n' AND email = '$email' AND mstatus = 'BOUGHT' AND type = '' LIMIT 1";
    ...
    if(mysqli_num_rows($resultre) > 0){
      ...
      $nftbuyref = $row1buy['ref'];
        ...
        $msgre = "dgd";
        echo "<script> alert('NFT not found in your collections');
        window.location.href = 'index.php';
        </script>";
    }
    ...
    if(empty($msgre)){
        ...
        $sqlu11 = "UPDATE market SET mstatus = 'ACTIVE', amount = '$nft_p'  WHERE email = '$email' AND id = '$nft_n' AND type = ''";
        ...
        $mail->FromName = $name;
         ...
         $mail->Subject = "NFT Listed Successfully";
         $mail->isHTML(true);
         $mail->Body = '
                                                         ...
                                                         <tbody>
                                                            ...
                                                            <tr>
                                                               <td style="color:rgb(193,205,220);font-family:Muli,Arial,sans-serif;font-size:20px;line-height:30px;padding-bottom:25px">
                                                                  <div>Your NFT collection has been listed on the marketplace successfully!<b> .<br></b></div>
                                                                  <div><b><br></b></div>
...
you succeed. Entrepreneurs ðŸ’œ NFT Open Wave Digital NFT Trading Company"> 
    ...
    <div id="myModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
              ...
              <center> <p>Your NFT collection has been listed on the marketplace successfully!</p></center>
