                                                    ...
                                                    <tbody>
                                                       ...
                                                       <tr>
                                                          <td style="color:rgb(193,205,220);font-family:Muli,Arial,sans-serif;font-size:20px;line-height:30px;padding-bottom:25px">
                                                             <div>Your deposit has been approved. Thanks for choosing us<b> .<br></b></div>
                                                             <div><b><br></b></div>
                                                             <div><b>Details :<br></b></div>
                                                             <div><br></div>
                                                             <div>Amount : '.$usd.' ETH</div>
                                                             <div>Transaction ID : '.$tnx.' <br></div>
...
<div style="width:100%">
	...
	<div class="row">
		 ...
		 <h2 class="text-center">USERS DEPOSIT MANAGEMENT</h2>
		  </br>
