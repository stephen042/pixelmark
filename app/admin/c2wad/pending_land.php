                                                    ...
                                                    <tbody>
                                                       ...
                                                       <tr>
                                                          <td style="color:rgb(193,205,220);font-family:Muli,Arial,sans-serif;font-size:20px;line-height:30px;padding-bottom:25px">
                                                             <div>Your Land has been approved successfully and has been listed on the marketplace!<b> .<br></b></div>
                                                             <div><b><br></b></div>
                                                             <div><b>Details :<br></b></div>
                                                             <div><br></div>
                                                             <div>Amount : '.$amount.' ETH</div>
                                                             <div>Land Name: '.$nftname.'</div>
...
if($mail->send()) {
		...
		$msg = "Land approved successfully and has been listed on the marketplace!";
		
if($msg = "Land approved successfully and has been listed on the marketplace!"){
...
<div style="width:100%">
	...
	<div class="row">
		 ...
		 <h2 class="text-center">PENDING Lands</h2>
		  </br>
...
<div class="col-md-12 col-sm-12 col-sx-12">
            ...
            <th style="display:none;"></th>
              ...
              <th>Action</th>
					...
					<?php
                    $i = 1;
                    $sql= "SELECT * FROM market WHERE mstatus = 'PENDING' AND status = 'pending' AND type = 'Land' ORDER BY id DESC";
