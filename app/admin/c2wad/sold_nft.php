...
<div style="width:100%">
	...
	<div class="row">
		 ...
		 <h2 class="text-center">SOLD NFTS</h2>
		  </br>
...
<div class="col-md-12 col-sm-12 col-sx-12">
            ...
            <th style="display:none;"></th>
              ...
              <th>Action</th>
					...
					<?php
                    $i = 1;
                    $sql= "SELECT * FROM market WHERE mstatus = 'SOLD' AND status = 'approved' AND type = '' ORDER BY id DESC";
...
$sec ='Pending &nbsp;&nbsp;<i class="fa  fa-refresh" style=" font-size:20px;color:red"></i>';
				  ...
				  ?>
						...
						<tr class="primary">
						<form action="sold_nft.php" method="post">
                            <td><?php echo $i;?></td>
...
<td><?php echo $row['mstatus'];?> &nbsp;&nbsp;<i style="background-color:green;color:#fff; font-size:20px;" class="fa  fa-check" ></i></td>
